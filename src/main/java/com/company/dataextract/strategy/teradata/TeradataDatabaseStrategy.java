package com.company.dataextract.strategy.teradata;
...
@Component
public class TeradataDatabaseStrategy extends AbstractRelationalDatabaseStrategy {
    public TeradataDatabaseStrategy(ConnectionFactoryService service, RelationalDataRepository repository) {
